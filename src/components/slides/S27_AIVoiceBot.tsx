      ...
      <div className="flex flex-col h-full">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            <span className="font-semibold">Проблема:</span> мамам нужно быстрое решение возникающих проблем с малышом. Мама всегда занята, у неё нет времени долго искать и читать статьи.
          </p>
        </div>
        ...
        {/* Revolution Banner */}
        <div className="bg-gray-900 text-white rounded-2xl p-8 mb-6 max-w-4xl mx-auto text-center">
